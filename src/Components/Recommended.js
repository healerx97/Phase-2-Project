...
function Recommended({mapAPI, setKeyLocation, setTerm, term, handleSubmit}) {

    function handleClick(e) {
        setTerm(e.target.textContent)
        handleSubmit(e)
        // fetch(`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${term}&key=${mapAPI}`)
        // .then(res=>res.json())
        // .then(data=> {
